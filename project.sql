...
INSERT INTO Customer (cus_id, cus_name, cus_password, cus_phone, cus_email, cus_address) VALUES
(1, 'John Doe', 'pass123', '123456789', 'john@example.com', 'New York'),
(2, 'Jane Smith', 'pass456', '987654321', 'jane@example.com', 'Los Angeles'),
(3, 'Alice Brown', 'alice789', '456123789', 'alice@example.com', 'Chicago'),
(4, 'Bob White', 'bob321', '321654987', 'bob@example.com', 'Houston'),
(5, 'Charlie Black', 'charlie654', '789321456', 'charlie@example.com', 'San Francisco'),
(6, 'David Green', 'david987', '159753468', 'david@example.com', 'Seattle'),
(7, 'Eve Blue', 'eve456', '357159486', 'eve@example.com', 'Denver'),
(8, 'Frank Yellow', 'frank123', '951753846', 'frank@example.com', 'Boston'),
(9, 'Grace Pink', 'grace789', '753159246', 'grace@example.com', 'Miami'),
(10, 'Henry Orange', 'henry321', '852963741', 'henry@example.com', 'Dallas');
...
INSERT INTO Film (film_id, title, genre_id, release_date, director, company_production, desciption, thumbnail) VALUES
(1, 'The Avengers', 1, '2012-05-04', 'Joss Whedon', 'Marvel Studios', 'Superhero film', 'avengers.jpg'),
(2, 'Inception', 5, '2010-07-16', 'Christopher Nolan', 'Warner Bros.', 'Sci-fi thriller', 'inception.jpg'),
(3, 'Titanic', 6, '1997-12-19', 'James Cameron', '20th Century Fox', 'Romantic drama', 'titanic.jpg'),
(4, 'The Conjuring', 4, '2013-07-19', 'James Wan', 'New Line Cinema', 'Horror film', 'conjuring.jpg'),
(5, 'Toy Story', 8, '1995-11-22', 'John Lasseter', 'Pixar', 'Animated film', 'toystory.jpg'),
(6, 'The Dark Knight', 1, '2008-07-18', 'Christopher Nolan', 'Warner Bros.', 'Superhero film', 'darkknight.jpg'),
(7, 'Interstellar', 5, '2014-11-07', 'Christopher Nolan', 'Paramount', 'Sci-fi adventure', 'interstellar.jpg'),
(8, 'Frozen', 10, '2013-11-27', 'Chris Buck', 'Disney', 'Fantasy animation', 'frozen.jpg'),
(9, 'Parasite', 3, '2019-05-30', 'Bong Joon-ho', 'CJ Entertainment', 'Thriller drama', 'parasite.jpg'),
(10, 'The Godfather', 3, '1972-03-24', 'Francis Ford Coppola', 'Paramount Pictures', 'Crime drama', 'godfather.jpg');
